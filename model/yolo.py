...
class YoloLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        pred_boxes[..., 2] = box_wh[..., 0] * self.anchors_buffer[0,0] / grid_size # width
        pred_boxes[..., 3] = box_wh[..., 1] * self.anchors_buffer[0,1] / grid_size # height
        ...
        return output.view(batch_size, -1, 5 + self.num_classes)
